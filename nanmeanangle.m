function [out] = nanmeanangle(in,dim,sens);

% NANMEANANGLE will calculate the mean of a set of angles (in degrees) based
% on polar considerations.
%
% Usage: [out] = nanmeanangle(in,dim)
%
...
% necessary:
%
% [out] = nanmeanangle(in,dim,sensitivity)
%
% Written by J.A. Dunne, 10-20-05
% Converted to nan-functionality by C.R. Edwards, 08-16,2008
%
