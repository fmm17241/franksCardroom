function traceRays( SSP, deltas, xs, alpha, Amp0, BeamType, Box, RunType )
...
for I = 1 : MaxSteps
    ...
    if ( DistBegTop < 0.0 && DistEndTop >= 0.0 )
        ...
        reflectRays( I1, BeamType, BC, Bdry.Top.cp, Bdry.Top.rho, 'TOP', ...
    ...
    if ( DistBegBot < 0.0 && DistEndBot >= 0.0 )
        ...
        BC = Bdry.Bot.Opt(1:1);
        reflectRays( I1, BeamType, BC, Bdry.Bot.cp, Bdry.Bot.rho, 'BOT', ...
