...
figure()
plot(X,pingsCompareTideOFF,'b')
hold on
plot(X,pingsCompareTideON,'r')
legend('Off Reef','','','','','On Reef')
ylabel('Hourly Pings')
title('Pings')
xlabel('Cross-shore Tidal Magnitude (m/s)')
...
tiledlayout(2,2)
nexttile()
plot(X,noiseCompareOFF)
ylabel('HF Noise (mV)')
title('High-Frequency Noise','OFF REEF')
xlabel('X-shore Tidal Current (m/s)')
xticks([-0.4 -0.2 0 0.2 0.4])
xticklabels({'Onshore', -0.2, 0, 0.2, 'Offshore'})
nexttile()
plot(X,noiseCompareON)
ylabel('HF Noise (mV)')
title('High-Frequency Noise','ON REEF')
xlabel('X-shore Tidal Current (m/s)')
xticks([-0.4 -0.2 0 0.2 0.4])
xticklabels({'Onshore', -0.2, 0, 0.2, 'Offshore'})
nexttile()
plot(X,pingsCompareTideOFF)
ylabel('Hourly Pings')
title('Pings','OFF REEF')
xlabel('X-shore Tidal Current (m/s)')
xticks([-0.4 -0.2 0 0.2 0.4])
xticklabels({'Onshore', -0.2, 0, 0.2, 'Offshore'})
nexttile()
plot(X,pingsCompareTideON)
ylabel('Hourly Pings')
title('Pings','ON REEF')
xlabel('X-shore Tidal Current (m/s)')
xticks([-0.4 -0.2 0 0.2 0.4])
