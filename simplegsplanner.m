...
givendir= [100]; 		% bearing degrees CW from N, consistent with waypoint reporting from glider
ds=7000;			% distance between waypoints at each bearing (set wrt max waypt abort distance, when_wpt_dist)
