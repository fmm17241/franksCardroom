function [filteredData, powerSnapWindLP, powerSnapWaveLP, powerSnapNoiseLP, powerWindWaveLP,...
    powerNoiseWaveLP,powerSnapTidesLP,powerSnapAbsTidesLP] = filterSnapDataRaw(envData, snapRateHourly, surfaceData,...
...
powerSnapWindLP   = Coherence_whelch_overlap(snapRateHourly.SnapCount,filteredData.Winds,3600,bins,1,1,1)
